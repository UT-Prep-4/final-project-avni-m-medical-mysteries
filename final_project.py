...
print("A patient walks into your hospital, with complaints of hyperventilation and chest pain. You have three choices.")
print("Option 1: check their vitals through a heart monitor, blood pressure, and heart rythm.")
print("Option 2: calm the patient down, because they are showing signs of a panic attack")
print("Option 3: Receive medical history before operating on the patient")
...
if choice1=="1":
  ...
  if choice1a=="a1":
    print("You find a strain in the heart, confirming pulmonary embolism, but blood pressure remains normal.")
    ...
    if choice2a=="d1":
      ...
      if choice6a=="1aa": 
        print("After a few days, you discharge the patient. You successfully saved them!")
      if choice6a=="1ab": 
    ...
    if choice2a=="c1":
          ...
          choice4a=input("Either choose to (1k) keep monitoring patient by getting a heart ultrasound, bed rest, and checking for brain bleed, or (1l) discharge the patient since they are stable.")
          if choice4a=="1k":
            print("You save the patient! By monitoring them and discharging after a week, you made sure they were fully okay. Make sure to tell them to follow up with a hematologist!")
          elif choice4a=="1l":
            ...
            if choice5a=="1z":
             print("You successfully saved the patient.")
            elif choice5a=="1x":
              print("You wasted too much time. You failed to save the patient!")

  elif choice1a=="b1": 
    print("You failed to save the patient! They had an underlying condition called pulmonary embolism, and without intensive treatment, they suffered from cardiac arrest")
...
if choice1=="2":
  ...
  if choice1b=="a2":
    ...
    if choice6a=="1i":
      print("Patient suffers from cardiovascular collapse. You failed. Rule of thumb: treat in order of airway, breathing, circulation.")
    elif choice6a=="1j":
      print("Vitals don't snap back to normal but they do stabilize. Patient still feels sharp pain in chest.")
      choice4a=input("Either choose to (1k) keep monitoring patient by getting a heart ultrasound, bed rest, and checking for brain bleed or (1l) discharge the patient since they are stable.")
      if choice4a=="1k":
  ...
  if choice1b=="b2":
    ...
    print("The patient collapses due to respiratory failure and cardiovascular collapse.")
    choice2b =input("Choose to either (1g) provide the drug's antidote to stop its effects, or (1h) provide IV for the patient.")
    if choice2b=="1g":
...
if choice1=="3":
  choice1c =input("Next, choose to (a3) ask specific questions to find an underlying condition, or (b3) run a physical on the patient.")
  if choice1c=="a3":
    ...
    if choice3a=="1gh":
      ...
      if choice2b=="1h":
       ...
       choice1a =input("Either choose to (a1) prepare an ultrasound and emergency medications, or (b1) send the patient back to the waiting room since their condition isn't bad")
       if choice1a=="b1":
          print("You failed to save the patient.")
       if choice1a=="a1":
        print("You find a strain in the heart, confirming pulmonary embolism, but blood pressure remains normal.")
        choice2a=input("Next, choose to (c1) use blood thinner to stabilize, or (d1) wait a few minutes for vital sign changes.")
        if choice2a=="d1":
